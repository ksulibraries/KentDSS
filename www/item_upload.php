...
?>
				<h2>Upload ZIP Archive to <?php echo $projectResult["name"]; ?></h2>
				...
				<p>To upload a ZIP archive file, click on the button below. Drag-and-drop is supported in Firefox and Chrome.</p>
				<p>The progress-bar is supported in Firefox, Chrome, and Safari.</p>
				<p>Upload only ONE ZIP archive at a time! The maximum file size supported is 2 GB. The file extension must be .zip</p>
