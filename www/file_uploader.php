...
if ($result['success']) {
	...
	if (trim($numberSynced["success"]) != "") $result = array('success'=>"There ".displayNumberWords($numberSynced["success"],"was","were","item","items")." synced.");
	elseif (trim($numberSynced["error"]) != "") $result = array('error'=>$numberSynced["error"]);
